...
$id = $_GET['p'];
$query = mysqli_query($con, "SELECT a.*, b.nama AS nama_kategori FROM produk a JOIN kategori b ON a.kategori_id=b.id WHERE a.produk_id='$id'");
    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <label for="curentFoto">Foto Produk Sekarang</label>
            ...
            ?>
                    ...
                    $queryUpdate = mysqli_query($con, "UPDATE produk SET kategori_id='$kategori', nama='$nama', harga='$harga', detail='$detail', ketersediaan_stok='$ketersediaan_stok' WHERE produk_id='$id'");
            ...
            if(isset($_POST['hapus'])){
                $queryHapus = mysqli_query($con, "DELETE FROM produk WHERE produk_id='$id'");
                if($queryHapus){
                    ?>
